...
## 【職務要約】
新卒にて中小ソフトウェア企業にて5年間、受託開発や客先開発にてJavaやOracleを使ったシステム開発に携わる。  
その後フリーランスに転身し、RailsやAWSを主に使ったサーバーサイドのWEB開発を主軸としながら、NuxtやJavascriptのフロントエンドやDBのパフォーマンスチューニング、terraformを使ったインフラ構築などフルスタックに対応しながら各プロジェクトに従事。  
また、スクラムを使ったアジャイル開発を直近では主に行なっており、エンジニアだけでなくスクラムでのプロジェクト貢献ができるように認定スクラムマスターの資格を取得し、エンジニアチームだけでなくビジネスサイドやデザイナー、QA、他エンジニアチームと連携しながら各プロジェクトのシステム開発に貢献している。  
システム開発以外では、エンジニアの採用面談/募集要項作成や新規チームのチームビルディング、新規エンジニアのオンボーディングといった対応などにも微力ながら尽力している。  
