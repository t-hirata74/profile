...
## 【職務要約/自己PR】
新卒にて中小ソフトウェア企業に入社後、2013年から正社員として5年ほど受託開発や客先開発でJavaやOracleを使ったシステム開発に携わりました。  

その後、2017年からフリーランスに転身し、Railsを主に使ったバックエンドのWEB開発をメインとしながら、NuxtやJavascriptなどのフロントエンドや、DBのパフォーマンスチューニング、terraformを使ったAWSインフラ構築などをフルスタックに対応しながら各プロジェクトにて従事してきました。  

その中で、スクラムを使ったアジャイル開発を直近では主に行なっており、エンジニアだけでなくスクラムでのプロジェクト貢献ができるように認定スクラムマスターの資格を取得し、エンジニアチームだけでなくビジネスサイドやデザイナー、QAなどの他ロールとも連携しながら各プロジェクトのシステム開発に貢献しております。今後も新たなプロジェクト先でもフルスタックで活躍できるようにしていければと考えております。  

また、システム開発以外では、エンジニアの採用面談/募集要項作成や新規エンジニアチームのチームビルディング、新規エンジニアのオンボーディングといった対応などにも微力ながら尽力しておりました。そのようなチームやプロジェクトへのリードスキルも今後高めていけるよう精進していきたいと考えております、何卒よろしくお願い致します。  
...
- 電気自動車のEV充電ローミングプロジェクトの新規開発(2024年4月〜2024年8月：5ヶ月)
  ...
  - 工程/作業：基本設計、アーキテクチャ設計（モジュラーモノリス）、機能見積もり、開発ハンドリング（チケット作成、アサイン割り振りなど）、開発、コードレビュー
